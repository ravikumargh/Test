...
function WidgetsComponent_div_580_img_12_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 116);
} if (rf & 2) {
    const mytimeline_r879 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function WidgetsComponent_div_580_button_13_Template(rf, ctx) { if (rf & 1) {
...
function WidgetsComponent_div_580_Template(rf, ctx) { if (rf & 1) {
    ...
    const mytimeline_r879 = ctx.$implicit;
