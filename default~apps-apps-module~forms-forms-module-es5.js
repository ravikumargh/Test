...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~apps-apps-module~forms-forms-module"], {
  /***/
  ...
  function node_modulesNgxQuill__ivy_ngcc__Fesm2015NgxQuillJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var QuillEditorComponent = QuillEditorComponent_1 =
    /*#__PURE__*/
    function () {
      function QuillEditorComponent(elementRef, domSanitizer, doc, platformId, renderer, zone, config) {
        var _this12 = this;

        _classCallCheck2(this, QuillEditorComponent);
        ...
        this.valueGetter = function (quillEditor, editorElement) {
          ...
          var modelValue = html;
          var format = getFormat(_this12.format, _this12.config.format);
        ...
        this.valueSetter = function (quillEditor, value) {
          ...
          if (format === 'html') {
            if (_this12.sanitize) {
              value = _this12.domSanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_2__["SecurityContext"].HTML, value);
            }
        ...
        this.selectionChangeHandler = function (range, oldRange, source) {
          var shouldTriggerOnModelTouched = !range && _this12.onModelTouched; // only emit changes when there's any listener

          if (!_this12.onBlur.observers.length && !_this12.onFocus.observers.length && !_this12.onSelectionChanged.observers.length && !shouldTriggerOnModelTouched) {
            return;
          }
          ...
          _this12.zone.run(function () {
            if (range === null) {
              _this12.onBlur.emit({
                editor: _this12.quillEditor,
                source: source
              });
            } else if (oldRange === null) {
              _this12.onFocus.emit({
                editor: _this12.quillEditor,
                source: source
              });
            }

            _this12.onSelectionChanged.emit({
              editor: _this12.quillEditor,
              oldRange: oldRange,
              range: range,
              source: source
        ...
        this.textChangeHandler = function (delta, oldDelta, source) {
          ...
          var text = _this12.quillEditor.getText();

          var content = _this12.quillEditor.getContents();

          var html = _this12.editorElem.querySelector('.ql-editor').innerHTML;

          if (html === '<p><br></p>' || html === '<div><br></div>') {
            html = null;
          }

          var trackChanges = _this12.trackChanges || _this12.config.trackChanges;
          var shouldTriggerOnModelChange = (source === Quill.sources.USER || trackChanges && trackChanges === 'all') && _this12.onModelChange; // only emit changes when there's any listener

          if (!_this12.onContentChanged.observers.length && !shouldTriggerOnModelChange) {
            return;
          }

          _this12.zone.run(function () {
            if (shouldTriggerOnModelChange) {
              _this12.onModelChange(_this12.valueGetter(_this12.quillEditor, _this12.editorElem));
            }

            _this12.onContentChanged.emit({
              content: content,
              delta: delta,
              editor: _this12.quillEditor,
              html: html,
        ...
        this.editorChangeHandler = function (event, current, old, source) {
          ...
          if (!_this12.onEditorChanged.observers.length) {
            return;
          } // only emit changes emitted by user interactions
      ...
      _createClass2(QuillEditorComponent, [{
        key: "onModelChange",
        ...
        value: function ngAfterViewInit() {
          ...
          if (this.styles) {
            Object.keys(this.styles).forEach(function (key) {
              _this13.renderer.setStyle(_this13.editorElem, key, _this13.styles[key]);
            });
          }
          ...
          if (!formats && formats === undefined) {
            formats = this.config.formats ? _toConsumableArray2(this.config.formats) : this.config.formats === null ? null : undefined;
          }

          this.zone.runOutsideAngular(function () {
            _this13.quillEditor = new Quill(_this13.editorElem, {
              bounds: bounds,
              debug: debug,
              formats: formats,
              modules: modules,
              ...
              strict: _this13.strict,
              theme: _this13.theme || (_this13.config.theme ? _this13.config.theme : 'snow')
            });
          });
          ...
          setTimeout(function () {
            return _this13.onEditorCreated.emit(_this13.quillEditor);
          });
        }
      }, {
        key: "ngOnDestroy",
          ...
          if (changes['styles']) {
            ...
            if (previousStyling) {
              Object.keys(previousStyling).forEach(function (key) {
                _this14.renderer.removeStyle(_this14.editorElem, key);
              });
            }

            if (currentStyling) {
              Object.keys(currentStyling).forEach(function (key) {
                _this14.renderer.setStyle(_this14.editorElem, key, _this14.styles[key]);
              });
            }
          }
        ...
        value: function addClasses(classList) {
          ...
          QuillEditorComponent_1.normalizeClassNames(classList).forEach(function (c) {
            _this15.renderer.addClass(_this15.editorElem, c);
          });
        }
      }, {
        key: "removeClasses",
        value: function removeClasses(classList) {
          ...
          QuillEditorComponent_1.normalizeClassNames(classList).forEach(function (c) {
            _this16.renderer.removeClass(_this16.editorElem, c);
          });
        }
      }, {
        key: "writeValue",
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "format", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "theme", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "modules", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "debug", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "readOnly", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "placeholder", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "maxLength", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "minLength", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "required", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "formats", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "customToolbarPosition", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "sanitize", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "styles", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "strict", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "scrollingContainer", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "bounds", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "customOptions", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "trackChanges", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "preserveWhitespace", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "classes", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()], QuillEditorComponent.prototype, "onEditorCreated", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()], QuillEditorComponent.prototype, "onEditorChanged", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()], QuillEditorComponent.prototype, "onContentChanged", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()], QuillEditorComponent.prototype, "onSelectionChanged", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()], QuillEditorComponent.prototype, "onFocus", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()], QuillEditorComponent.prototype, "onBlur", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "valueGetter", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()], QuillEditorComponent.prototype, "valueSetter", void 0);
    QuillEditorComponent = QuillEditorComponent_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ElementRef"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(2, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_common__WEBPACK_IMPORTED_MODULE_1__["DOCUMENT"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(3, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_2__["PLATFORM_ID"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(4, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Renderer2"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(5, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgZone"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(6, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(QUILL_CONFIG_TOKEN))], QuillEditorComponent);

    var QuillViewHTMLComponent =
    /*#__PURE__*/
    function () {
      function QuillViewHTMLComponent(sanitizer, config) {
        _classCallCheck2(this, QuillViewHTMLComponent);
      ...
      _createClass2(QuillViewHTMLComponent, [{
        key: "ngOnChanges",
        value: function ngOnChanges(changes) {
          if (changes.theme) {
            ...
            var _theme3 = this.config.theme ? this.config.theme : 'snow';

            this.themeClass = "ql-".concat(_theme3, " ngx-quill-view-html");
          }
    ...
    QuillViewHTMLComponent.ɵfac = function QuillViewHTMLComponent_Factory(t) {
      return new (t || QuillViewHTMLComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](QUILL_CONFIG_TOKEN));
    };
    ...
    QuillViewHTMLComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(QUILL_CONFIG_TOKEN))], QuillViewHTMLComponent);
    var Quill$1 = null;

    var QuillViewComponent =
    /*#__PURE__*/
    function () {
      function QuillViewComponent(platformId, config, renderer, elementRef) {
        var _this17 = this;

        _classCallCheck2(this, QuillViewComponent);
        ...
        this.valueSetter = function (quillEditor, value) {
          var format = getFormat(_this17.format, _this17.config.format);
          var content = value;
      ...
      _createClass2(QuillViewComponent, [{
        key: "ngOnChanges",
        value: function ngOnChanges(changes) {
          if (!this.quillEditor) {
            return;
    ...
    QuillViewComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_2__["PLATFORM_ID"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(QUILL_CONFIG_TOKEN)), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(2, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Renderer2"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(3, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ElementRef"]))], QuillViewComponent);
    var QuillModule_1;

    var QuillModule = QuillModule_1 =
    /*#__PURE__*/
    function () {
      function QuillModule() {
        _classCallCheck2(this, QuillModule);
      }

      _createClass2(QuillModule, null, [{
        key: "forRoot",
  ...
  /***/
  function node_modulesNgxQuillNode_modulesTslibTslibEs6Js(module, __webpack_exports__, __webpack_require__) {
    "use strict";
...
//# sourceMappingURL=default~apps-apps-module~forms-forms-module-es5.js.map