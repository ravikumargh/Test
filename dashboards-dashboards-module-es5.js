...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboards-dashboards-module"], {
      ...
      */
      ...
      var y,
        ...
        return a(t, [{
          ...
          value: function value() {
            var t = this;
            this.w.config.annotations.rects.map(function (e) {
              t.addRect(e, !1);
            });
          }
        }, {
          ...
          value: function value() {
            var t = this;
            this.w.config.annotations.texts.map(function (e) {
              t.addText(e);
            });
          }
        }, {
          ...
          value: function value(t, e, i) {
            ...
            i && (P = i);
            var T = P.w,
                z = T.globals.dom.baseEl.querySelector(l),
              ...
              textAnchor: n || "start",
              fontSize: c || "12px",
              fontWeight: g || "regular",
              fontFamily: d || T.config.chart.fontFamily,
              foreColor: h || T.config.chart.foreColor,
              cssClass: u
            });
            z.appendChild(I.node);
            var M = I.bbox();

            if (r) {
              var X = this.graphics.drawRect(M.x - y, M.y - L, M.width + y + k, M.height + S + L, b, f || "transparent", 1, p, m, x);
              z.insertBefore(X.node, I.node);
            }

            return e && T.globals.memory.methodsToExec.push({
              context: P,
              method: P.addText,
              label: "addText",
              params: t
          ...
          value: function value(t) {
            ...
            i && (s = i);
            var r = s.w;
            String(a.width).indexOf("%") > -1 && (a.width = parseInt(a.width, 10) * parseInt(r.globals.svgWidth, 10) / 100);
            var n = s.graphics.drawRect(a.x, a.y, a.width, a.height, a.borderRadius, a.backgroundColor, a.opacity, a.borderWidth, a.borderColor);

            if (r.globals.dom.elRects.add(n), a.rotate) {
              var o = s.graphics.rotateAroundCenter(n.node);
              n.attr({
                transform: "translate(".concat(o.x, " ").concat(o.y, ") rotate(").concat(a.rotate, ")")
              });
            }

            return e && r.globals.memory.methodsToExec.push({
              context: s,
              method: s.addRect,
              label: "addRect",
              params: t
          ...
          value: function value(t, e, i) {
            ...
            return x.size(h, d).move(r, o), u.appendChild(x.node), e && p.globals.memory.methodsToExec.push({
              context: f,
              method: f.addImage,
              label: "addImage",
              params: t
            ...
            return {
              ...
              tooltip: {
                ...
                custom: function custom(t) {
                  ...
                  } else u = n.config.tooltip.x.formatter(o), f = n.config.tooltip.x.formatter(l);
              ...
              if (o.globals.axisCharts) {
                if ("category" === o.config.xaxis.type || o.config.xaxis.convertedCatToNumeric) if (o.globals.isBarHorizontal) {
                  var a = o.globals.yLabelFormatters[0],
                      s = new R(e.ctx).getActiveConfigSeriesIndex();
        ...
        return a(t, [{
          ...
          value: function value(t) {
            ...
            if (!e.config.yaxis[t].show) return o;
            var l = i.group({
            ...
            return e.config.yaxis.map(function (s, r) {
              if (s.show && s.labels.show && e.globals.yAxisScale[r].result.length) {
                ...
                if (void 0 !== o && 0 !== o.length || (o = e.globals.yAxisScale[r].niceMax), e.globals.isBarHorizontal) {
                  ...
                  o = n(o = g.getLargestStringFromArr(h), {
                    seriesIndex: r,
                    dataPointIndex: -1,
                    w: e
                ...
                var c = new p(t.dCtx.ctx),
                    d = c.getTextRects(o, s.labels.style.fontSize),
                    u = d;
                o !== l && (u = c.getTextRects(l, s.labels.style.fontSize)), i.push({
                  width: (u.width > d.width ? u.width : d.width) + a,
        ...
        return a(t, [{
          ...
          value: function value(t) {
            ...
            n && f[0] && h.tooltipTitle && (null == c || l.globals.collapsedSeriesIndices.indexOf(i) > -1 ? f[0].parentNode.style.display = "none" : f[0].parentNode.style.display = l.config.tooltip.items.display);
          }
        }, {
        ...
        return a(t, [{
          ...
          value: function value(t) {
            ...
            }, i.e = s, !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared) || this.tConfig.onDatasetHover.highlightDataSeries && new R(e).toggleSeriesOnHover(s, s.target.parentNode);
        ...
        return a(t, [{
          ...
          value: function value(t) {
            var e = t.bc,
                ...
                r = t.elSeries,
                n = this.w,
                o = new p(this.barCtx.ctx);

            if (this.barCtx.barOptions.colors.backgroundBarColors.length > 0 && 0 === i) {
              e >= this.barCtx.barOptions.colors.backgroundBarColors.length && (e = 0);
              var l = this.barCtx.barOptions.colors.backgroundBarColors[e],
                  h = o.drawRect(0, a, n.globals.gridWidth, s, 0, l, this.barCtx.barOptions.colors.backgroundBarOpacity);
              r.add(h), h.node.classList.add("apexcharts-backgroundBar");
            }
          }
        }, {
        ...
        return a(t, [{
          ...
          value: function value(t) {
            ...
            return b = b + c.line(y.newX, x) + y.path + c.line(s, x + i - a) + c.line(s, x), m = m + c.line(s, x) + y.ending_p_from + c.line(s, x + i - a) + c.line(s, x + i - a) + c.line(s, x), h.globals.isXNumeric || (n += o), this.barHelpers.barBackground({
              bc: f,
              i: d,
              y1: x - i * this.visibleI,
              y2: i * this.seriesLen,
              elSeries: l
            }), {
              pathTo: b,
          ...
          value: function value(t) {
            ...
            if (m = m + c.line(b, w.newY) + w.path + c.line(b + r - o, n) + c.line(b - o / 2, n), v = v + c.line(b, n) + w.ending_p_from + c.line(b + r - o, n) + c.line(b + r - o, n) + c.line(b - o / 2, n), h.globals.isXNumeric || (i += s), this.barOptions.colors.backgroundBarColors.length > 0 && 0 === d) {
              ...
              var k = this.barOptions.colors.backgroundBarColors[f],
                  A = c.drawRect(b - o / 2 - r * this.visibleI, 0, r * this.seriesLen + o / 2, h.globals.gridHeight, 0, k, this.barOptions.colors.backgroundBarOpacity);
        ...
        return o(i, bt), a(i, [{
          ...
          value: function value(t) {
            ...
            for (var p, x = i, b = 0, m = 0; m < this.prevYF.length; m++) {
              b += isNaN(this.prevYF[m][d]) ? 0 : this.prevYF[m][d];
            }
            ...
            if (c > 0 && !h.globals.isXNumeric || c > 0 && h.globals.isXNumeric && h.globals.seriesX[c - 1][d] === h.globals.seriesX[c][d]) {
              ...
              if (void 0 !== this.prevY[c - 1]) for (var k = 1; k < w; k++) {
                if (!isNaN(this.prevY[c - k][d])) {
                  y = this.prevY[c - k][d];
                  break;
                }
              }
              ...
              void 0 === v && (v = h.globals.gridHeight), p = this.prevYF[0].every(function (t) {
                return 0 === t;
            ...
            var S = {
              ...
              y: a
                ...
                C = this.barHelpers.getBarEndingShape(h, S, this.series, c, d);
            this.yArrj.push(C.newY), this.yArrjF.push(Math.abs(p - C.newY)), this.yArrjVal.push(this.series[c][d]);
            var L = this.graphics.move(x, p),
                P = this.graphics.move(x, p);

            if (h.globals.previousPaths.length > 0 && (P = this.bar.getPreviousPath(g, d, !1)), L = L + this.graphics.line(x, C.newY) + C.path + this.graphics.line(x + r - o, p) + this.graphics.line(x - o / 2, p), P = P + this.graphics.line(x, p) + this.graphics.line(x + r - o, p) + this.graphics.line(x + r - o, p) + this.graphics.line(x + r - o, p) + this.graphics.line(x - o / 2, p), h.config.plotOptions.bar.colors.backgroundBarColors.length > 0 && 0 === c) {
              ...
              var T = h.config.plotOptions.bar.colors.backgroundBarColors[u],
                  z = this.graphics.drawRect(x, 0, r, h.globals.gridHeight, 0, T, h.config.plotOptions.bar.colors.backgroundBarOpacity);
              l.add(z), z.node.classList.add("apexcharts-backgroundBar");
            }
        ...
        return a(t, [{
          ...
          value: function value() {
            ...
            }), t.dom.elRects = t.dom.Paper.group().attr({
              class: "apexcharts-annotations-rects"
            }), t.dom.elDefs = t.dom.Paper.defs(), t.dom.elLegendWrap = document.createElement("div"), t.dom.elLegendWrap.classList.add("apexcharts-legend"), t.dom.elWrap.appendChild(t.dom.elLegendWrap), t.dom.Paper.add(t.dom.elRects), t.dom.Paper.add(t.dom.elGraphical), t.dom.elGraphical.add(t.dom.elDefs);
          }
        }, {
          key: "plotChartType",
          value: function value(t, e) {
            ...
            case "A":
              t = (e = function (t, e) {
                var i,
                    ...
                    F = new SVG.Point(E, Y),
                    D = [];
                if (0 === T || 0 === z || R.x === F.x && R.y === F.y) return [["C", R.x, R.y, F.x, F.y, F.x, F.y]];
                i = new SVG.Point((R.x - F.x) / 2, (R.y - F.y) / 2).transform(new SVG.Matrix().rotate(I)), (a = i.x * i.x / (T * T) + i.y * i.y / (z * z)) > 1 && (a = Math.sqrt(a), T *= a, z *= a);
                s = new SVG.Matrix().rotate(I).scale(1 / T, 1 / z).rotate(-I), R = R.transform(s), F = F.transform(s), r = [F.x - R.x, F.y - R.y], o = r[0] * r[0] + r[1] * r[1], n = Math.sqrt(o), r[0] /= n, r[1] /= n, l = o < 4 ? Math.sqrt(1 - o / 4) : 0, M === X && (l *= -1);
      ...
      var zt = function () {
        ...
        return a(t, [{
          ...
          value: function value() {
            ...
            this.killSVG(e.Paper), e.Paper.remove(), e.elWrap = null, e.elGraphical = null, e.elRects = null, e.elLegendWrap = null, e.baseEl = null, e.elGridRect = null, e.elGridRectMask = null, e.elGridRectMarkerMask = null, e.elDefs = null;
          }
        }]), t;
      }(),
          Mt = function () {
        ...
        return a(t, [{
          ...
          value: function value() {
            ...
            return new Promise(function (s, r) {
              ...
              i.annotations = new S(i), "back" === a.config.annotations.rectsPosition && i.annotations.drawRects(), "back" === a.config.grid.position && n && a.globals.dom.elGraphical.add(n.el);
              var o = new O(t.ctx),
                  l = new G(t.ctx);
              if (null !== n && (o.xAxisLabelCorrections(n.xAxisTickWidth), l.setYAxisTextAlignments()), "back" === a.config.annotations.position && (i.annotations.drawAnnotations(), i.annotations.drawTexts()), e.elGraph instanceof Array) for (var h = 0; h < e.elGraph.length; h++) {
                a.globals.dom.elGraphical.add(e.elGraph[h]);
              } else a.globals.dom.elGraphical.add(e.elGraph);

              if ("front" === a.config.grid.position && n && a.globals.dom.elGraphical.add(n.el), "front" === a.config.xaxis.crosshairs.position && i.crosshairs.drawXCrosshairs(), "front" === a.config.yaxis[0].crosshairs.position && i.crosshairs.drawYCrosshairs(), "front" === a.config.annotations.rectsPosition && i.annotations.drawRects(), "front" === a.config.annotations.position && (i.annotations.drawAnnotations(), i.annotations.drawTexts()), !a.globals.noData) {
          ...
          value: function value(t) {
            var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0,
                a = this;
            i && (a = i), a.annotations.addRect(t, e, a);
          }
        }, {
          key: "getChartArea",
          value: function value() {
  ...
  function srcAppDashboardsDashboard1Dashboard1ComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _c0 = ["chart"];
    var _c1 = ["visitor-chart"];
    var _c2 = ["newsletter-chart"];
    ...
    function () {
      function Dashboard1Component() {
        ...
        this.barChartData = [{
          data: [1.1, 1.4, 1.1, 0.9, 1.9, 1, 0.3, 1.1, 1.4, 1.1, 0.9, 1.9],
          label: 'Cost'
        }];
        ...
        this.barChartType = 'bar'; // lineChart

        this.lineChartData = [{
          data: [65, 39, 80, 15, 76, 35, 40],
          label: 'Mine 1'
        }, {
          data: [15, 58, 20, 69, 16, 27, 50],
          label: 'Mine 2'
        }, {
          data: [18, 50, 40, 15, 26, 30, 30],
          label: 'Mine 3'
        }];
        ...
        this.chartOptions = {
          series: [{
            name: 'Sum of Tonnes',
            data: [240, 55, 180, 56, 561, 58]
          }, {
            name: 'Sum of Royalty',
            data: [720, 185, 550, 298, 1387, 165]
          }],
          chart: {
            type: 'bar',
            height: 340
          ...
          xaxis: {
            categories: ['Mine 1', 'Mine 2', 'Mine 3', 'Mine 4', 'Mine 5', 'Mine 6']
          },
          legend: {
            show: false
          },
        ...
        this.productChartOptions = {
          series: [{
            name: 'Sum of Tonnes - 2019',
            data: [2130, 1005, 1860]
          }, {
            name: 'Sum of Royalty - 2019',
            data: [6390, 3015, 5580]
          }, {
            name: 'Sum of Tonnes - 2020',
            data: [415, 165, 180]
          }, {
            name: 'Sum of Royalty - 2020',
            data: [1245, 495, 550]
          }],
          chart: {
            type: 'bar',
          ...
          xaxis: {
            categories: ['0-5 MM', '5-10 MM', '10-20 MM']
          },
          legend: {
            show: false
          },
          fill: {
            colors: ['#26c6da', '#1e88e5', '#ffce56', '#f7b105'],
            opacity: 1
          },
          tooltip: {
            fillSeriesColor: false,
        ...
        this.VisitorChartOptions = {
          ...
          labels: ['Mine 1', 'Mine 2', 'Mine 3', 'Mine 4', 'Mine 5'],
          colors: ['#1e88e5', '#26c6da', '#745af2', '#28a745', '#3ceff1'],
          responsive: [{
            breakpoint: 480,
            options: {
              chart: {
        ...
        this.newsletterchartOptions = {
          series: [{
            name: 'Mine 1',
            data: [180, 5000, 15000, 8000, 15000, 9000, 30000, 5000]
          }, {
            name: 'Mine 2',
            data: [100, 3000, 5000, 2000, 8000, 1000, 5000, 1000]
          }, {
            name: 'Mine 3',
            data: [175, 500, 1500, 800, 1500, 900, 3000, 2000]
          }, {
            name: 'Mine 4',
            data: [2000, 3000, 5000, 2000, 8000, 1000, 5000, 2000]
          }, {
            name: 'Mine 5',
            data: [500, 5000, 1500, 800, 1500, 900, 3000, 200]
          }],
          chart: {
            height: 290,
            type: 'area'
    ...
    Dashboard1Component.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      viewQuery: function Dashboard1Component_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 201,
      vars: 59,
      consts: [["fxLayout", "row wrap"], ["fxFlex.gt-sm", "25", "fxFlex.gt-xs", "100", "fxFlex", "100"], [1, "d-flex", "no-block"], [1, "m-r-10", "no-shrink"], ["mat-fab", "", "mat-card-icon", "", 1, "shadow-none", "bg-inverse", "bg-success"], [1, "m-0"], [1, "text-muted", "m-0"], ["mat-fab", "", "color", "warn", "mat-card-icon", "", 1, "shadow-none", "bg-warning"], ["mat-fab", "", "color", "accent", "mat-card-icon", "", 1, "shadow-none"], ["mat-fab", "", "color", "warn", "mat-card-icon", "", 1, "shadow-none", "bg-danger"], ["fxFlex.gt-lg", "75", "fxFlex.gt-md", "60", "fxFlex.gt-xs", "100", "fxFlex", "100"], ["id", "chart"], [3, "series", "chart", "dataLabels", "plotOptions", "yaxis", "legend", "fill", "stroke", "tooltip", "xaxis", "grid"], [1, "list-inline", "text-center"], [1, "text-muted", "text-info", "m-0"], [1, "fa", "fa-circle", "font-10", "m-r-10"], [1, "text-muted", "text-success", "m-0"], ["fxFlex.gt-lg", "25", "fxFlex.gt-md", "40", "fxFlex.gt-xs", "100", "fxFlex", "100"], ["id", "visitor-chart"], [3, "series", "chart", "labels", "responsive", "tooltip", "legend", "colors", "dataLabels", "plotOptions", "stroke"], [1, "text-muted", "text-purple", "m-0"], ["fxFlex.gt-sm", "33.33", "fxFlex.gt-xs", "100", "fxFlex", "100"], [1, "bg-info"], [1, "d-flex", "no-block", "align-items-center"], [1, "stats"], [1, "text-white", "m-0"], [1, "text-white", "m-t-0"], [1, "ml-auto", 2, "height", "84px", "width", "100px"], ["baseChart", "", 3, "datasets", "labels", "options", "colors", "legend", "chartType"], [1, "bg-purple"], [1, "bg-success"], ["id", "newsletter-chart"], [3, "series", "chart", "xaxis", "stroke", "tooltip", "dataLabels", "legend", "colors", "markers"], [1, "list-inline", "text-center", "p-t-10"]],
      template: function Dashboard1Component_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, "Mines");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](37, "4995");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](38, "h6", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](39, "Sum of Tonnes");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](50, "14985");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](51, "h6", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](52, "Sum of Royalty");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](58, "Time line ");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](59, "mat-card-subtitle");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](60, "Sum of Tonnes Vs Sum of Royalty");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](61, "div", 11);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](62, "apx-chart", 12);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](67, "Sum of Royalty");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](71, "Sum of Tonnes");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](76, "Total production");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](77, "mat-card-subtitle");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](78, "Total production of all mines");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](79, "div", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](80, "apx-chart", 19);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](85, "h6", 16);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](86, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](87, "Mine 1");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](89, "h6", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](90, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](91, "Mine 2");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](93, "h6", 20);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](94, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](95, "Mine 3");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](99, "Mine 4");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](101, "h6", 20);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](102, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](103, "Mine 5");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](106, "mat-card", 22);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](111, "Production");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](112, "h6", 26);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](113, "March 2017");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](114, "h1", 25);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](115, "15480");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](117, "canvas", 28);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](119, "mat-card", 29);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](123, "h3", 25);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](124, "Production");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](125, "h6", 26);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](126, "March 2018");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](127, "h1", 25);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](128, "25187");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](130, "canvas", 28);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](132, "mat-card", 30);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](137, "Production");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](138, "h6", 26);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](139, "March 2019");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](140, "h1", 25);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](141, "35487");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](143, "canvas", 28);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](149, "Time line");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](150, "mat-card-subtitle");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](151, "Sum of Tonnes Vs Sum of Royalty");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](152, "div", 11);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](153, "apx-chart", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](154, "ul", 13);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](158, "Sum of Royalty - 2019");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](162, "Sum of Tonnes - 2019");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](164, "h6", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](165, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](166, "Sum of Royalty - 2020");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](168, "h6", 16);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](169, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](170, "Sum of Tonnes - 2020 ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](172, "mat-card");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](173, "mat-card-content");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](174, "mat-card-title");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](175, "Monthly chart");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](176, "mat-card-subtitle");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](177, "Overview of Monthly chart");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](178, "div", 31);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](179, "apx-chart", 32);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](180, "ul", 33);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](181, "li");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](182, "h6", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](183, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](184, "Mine 1");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](186, "h6", 16);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](187, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](188, "Mine 2");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](190, "h6", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](191, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](192, "Mine 3");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](194, "h6", 16);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](195, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](196, "Mine 4");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](198, "h6", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](199, "i", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](200, "Mine 5");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("series", ctx.productChartOptions.series)("chart", ctx.productChartOptions.chart)("dataLabels", ctx.productChartOptions.dataLabels)("plotOptions", ctx.productChartOptions.plotOptions)("yaxis", ctx.productChartOptions.yaxis)("legend", ctx.productChartOptions.legend)("fill", ctx.productChartOptions.fill)("stroke", ctx.productChartOptions.stroke)("tooltip", ctx.productChartOptions.tooltip)("xaxis", ctx.productChartOptions.xaxis)("grid", ctx.productChartOptions.grid);
      ...
      directives: [_angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_2__["DefaultLayoutDirective"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_2__["DefaultFlexDirective"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCard"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardContent"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButton"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIcon"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardTitle"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardSubtitle"], ng_apexcharts__WEBPACK_IMPORTED_MODULE_1__["ChartComponent"], ng2_charts__WEBPACK_IMPORTED_MODULE_6__["BaseChartDirective"]],
      styles: [".piechart[_ngcontent-%COMP%] {\n  height: 300px;\n  width: 280px;\n  margin: 0 auto; }\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
  ...
  /***/
  function srcAppDashboardsDashboard1DataJson(module) {
  ...
  function srcAppDashboardsDashboard2Dashboard2ComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _c0 = ["chart"];
    var _c1 = ["newsletter-chart"];
    var _c2 = ["visitor-chart"];

    function Dashboard2Component_mat_header_cell_28_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function Dashboard2Component_mat_cell_29_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](element_r75.date);
      }
    }

    function Dashboard2Component_mat_header_cell_31_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Mine ");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function Dashboard2Component_mat_cell_32_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](element_r76.name);
      }
    }

    function Dashboard2Component_mat_header_cell_34_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
    ...
    function Dashboard2Component_mat_cell_35_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", element_r77.product, " ");
      }
    }

    function Dashboard2Component_mat_header_cell_37_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Tones ");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function Dashboard2Component_mat_cell_38_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "span", 48);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "tones:");
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", element_r78.tones, " ");
      }
    }

    function Dashboard2Component_mat_header_cell_40_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Royalty Due ");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function Dashboard2Component_mat_cell_41_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "span", 48);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "royaltydue:");
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", element_r79.royaltydue, " ");
      }
    }

    function Dashboard2Component_mat_header_row_42_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-header-row");
      }
    }

    function Dashboard2Component_mat_row_43_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ELEMENT_DATA = [{
      ...
      name: 'Mine 5',
      product: 'carbon@gmail.com',
      tones: '45',
      royaltydue: 'Senior Developer'
    }, {
      date: '11/23/2019      ',
      pic: 'assets/images/users/7.jpg',
      name: 'Mine 1',
      product: 'nitro@gmail.com',
      tones: '45',
      royaltydue: 'Junior Developer'
    }, {
      date: '10/29/2019      ',
      pic: 'assets/images/users/1.jpg',
      name: 'Mine 2',
      product: 'nirav@gmail.com',
      tones: '45',
      royaltydue: 'Hacker'
    }, {
      date: '3/14/2019      ',
      ...
      pic: 'assets/images/users/3.jpg',
      name: 'Mine 4',
      product: 'deo@gmail.com',
      tones: '45',
      royaltydue: 'Developer'
    }, {
      date: '12/9/2019      ',
      pic: 'assets/images/users/4.jpg',
      name: 'Mine 5',
      product: 'lon@gmail.com',
      tones: '45',
      royaltydue: 'Front end Developer'
    }, {
      date: '11/23/2019      ',
      pic: 'assets/images/users/5.jpg',
      name: 'Mine 6',
      product: 'son@gmail.com',
      tones: '45',
      royaltydue: 'Hacker'
    }];
    ...
    function () {
      ...
      function Dashboard2Component(breakpointObserver) {
        ...
        this.barChartLegend = false;
        this.barChartType = 'bar'; // tslint:disable-next-line:member-ordering

        this.displayedColumns = ['date', 'name', 'product', 'royaltydue']; // tslint:disable-next-line:member-ordering
        ...
        breakpointObserver.observe(['(max-width: 600px)']).subscribe(function (result) {
          _this3.displayedColumns = result.matches ? ['date', 'name', 'product', 'tones', 'royaltydue'] : ['date', 'name', 'product', 'tones', 'royaltydue'];
        });
        this.productChartOptions = {
          series: [{
            name: 'Sum of Tonnes - 2019',
    ...
    Dashboard2Component.ɵfac = function Dashboard2Component_Factory(t) {
      return new (t || Dashboard2Component)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_3__["BreakpointObserver"]));
    };
    ...
    Dashboard2Component.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 236,
      vars: 70,
      consts: [["fxLayout", "row wrap"], ["fxFlex.gt-lg", "25", "fxFlex.gt-md", "40", "fxFlex.gt-xs", "100", "fxFlex", "100"], ["id", "chart"], [3, "series", "chart", "dataLabels", "plotOptions", "yaxis", "legend", "fill", "stroke", "tooltip", "xaxis", "grid"], [1, "list-inline", "text-center"], [1, "text-muted", "text-info", "m-0"], [1, "fa", "fa-circle", "font-10", "m-r-10"], [1, "text-muted", "text-success", "m-0"], ["fxFlex.gt-lg", "75", "fxFlex.gt-md", "60", "fxFlex.gt-xs", "100", "fxFlex", "100"], [1, "responsive-table"], [1, "contactlist", 3, "dataSource"], ["table", ""], ["matColumnDef", "date"], [4, "matHeaderCellDef"], [4, "matCellDef"], ["matColumnDef", "name"], ["matColumnDef", "product"], ["matColumnDef", "tones"], ["matColumnDef", "royaltydue"], [4, "matHeaderRowDef"], [4, "matRowDef", "matRowDefColumns"], [3, "pageSize", "pageSizeOptions"], ["paginator", ""], ["fxFlex.gt-md", "33.33", "fxFlex.gt-xs", "100", "fxFlex", "100"], ["fxFlex.gt-sm", "100", "fxFlex.gt-xs", "100", "fxFlex", "100"], [1, "bg-success"], [1, "d-flex", "p-t-20", "p-b-20", "no-block", "align-items-center"], [1, "stats"], [1, "text-white", "m-0"], [1, "text-white", "m-t-0"], [1, "ml-auto", 2, "height", "84px", "width", "100px"], ["baseChart", "", 3, "datasets", "labels", "options", "colors", "legend", "chartType"], [1, "bg-purple"], ["id", "visitor-chart"], [3, "series", "chart", "labels", "responsive", "tooltip", "legend", "colors", "dataLabels", "plotOptions", "stroke"], [1, "text-muted", "text-purple", "m-0"], ["fxFlex.gt-sm", "25", "fxFlex.gt-xs", "100", "fxFlex", "100"], [1, "d-flex", "no-block"], [1, "m-r-10", "no-shrink"], ["mat-fab", "", "mat-card-icon", "", 1, "shadow-none", "bg-inverse", "bg-success"], [1, "m-0"], [1, "text-muted", "m-0"], ["mat-fab", "", "color", "warn", "mat-card-icon", "", 1, "shadow-none", "bg-warning"], ["mat-fab", "", "color", "accent", "mat-card-icon", "", 1, "shadow-none"], ["mat-fab", "", "color", "warn", "mat-card-icon", "", 1, "shadow-none", "bg-danger"], ["id", "newsletter-chart"], [3, "series", "chart", "xaxis", "stroke", "tooltip", "dataLabels", "legend", "colors", "markers"], [1, "list-inline", "text-center", "p-t-10"], [1, "header-label"]],
      template: function Dashboard2Component_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Time line Chart");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "mat-card-subtitle");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "Sum of Tonnes Vs Sum of Royalty");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "div", 2);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](9, "apx-chart", 3);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](14, "Sum of Royalty");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](18, "Sum of Tonnes");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](23, "Timeline data");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](24, "div", 9);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](25, "mat-table", 10, 11);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](27, 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](28, Dashboard2Component_mat_header_cell_28_Template, 2, 0, "mat-header-cell", 13);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](29, Dashboard2Component_mat_cell_29_Template, 5, 1, "mat-cell", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](30, 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](31, Dashboard2Component_mat_header_cell_31_Template, 2, 0, "mat-header-cell", 13);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](32, Dashboard2Component_mat_cell_32_Template, 5, 1, "mat-cell", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](33, 16);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](34, Dashboard2Component_mat_header_cell_34_Template, 2, 0, "mat-header-cell", 13);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](35, Dashboard2Component_mat_cell_35_Template, 4, 1, "mat-cell", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](36, 17);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](37, Dashboard2Component_mat_header_cell_37_Template, 2, 0, "mat-header-cell", 13);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](38, Dashboard2Component_mat_cell_38_Template, 4, 1, "mat-cell", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](39, 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](40, Dashboard2Component_mat_header_cell_40_Template, 2, 0, "mat-header-cell", 13);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](41, Dashboard2Component_mat_cell_41_Template, 4, 1, "mat-cell", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](42, Dashboard2Component_mat_header_row_42_Template, 1, 0, "mat-header-row", 19);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](43, Dashboard2Component_mat_row_43_Template, 1, 0, "mat-row", 20);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](44, "mat-paginator", 21, 22);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](54, "h3", 28);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](55, "Production");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](56, "h6", 29);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](57, "March 2019");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](58, "h1", 28);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](59, "35487");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](61, "canvas", 31);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](68, "h3", 28);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](69, "Production");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](70, "h6", 29);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](71, "March 2018");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](72, "h1", 28);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](73, "35487");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](75, "canvas", 31);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](80, "Total production");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](81, "mat-card-subtitle");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](82, "Total production of all mines");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](83, "div", 33);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](84, "apx-chart", 34);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](87, "ul", 4);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](88, "li");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](89, "h6", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](90, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](91, "Mine 1");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](93, "h6", 5);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](94, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](95, "Mine 2");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](97, "h6", 35);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](98, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](99, "Mine 3");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](101, "h6", 35);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](102, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](103, "Mine 4");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](105, "h6", 35);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](106, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](107, "Mine 5");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](111, "mat-card-title");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](112, "Time line");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](113, "mat-card-subtitle");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](114, "Sum of Tonnes Vs Sum of Royalty");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](115, "div", 2);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](116, "apx-chart", 3);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](117, "ul", 4);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](118, "li");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](119, "h6", 5);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](120, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](121, "Sum of Royalty");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](123, "h6", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](124, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](125, "Sum of Tonnes");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](134, "account_circle");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](136, "h3", 40);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](137, "5");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](138, "h6", 41);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](139, "Mines");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](145, "button", 42);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](146, "mat-icon");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](147, "local_mall");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](149, "h3", 40);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](150, "3");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](151, "h6", 41);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](152, "Products");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](154, "mat-card");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](155, "mat-card-content");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](158, "button", 43);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](159, "mat-icon");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](162, "h3", 40);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](163, "4995");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](164, "h6", 41);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](165, "Sum of Tonnes");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](171, "button", 44);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](172, "mat-icon");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](173, "content_paste");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](175, "h3", 40);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](176, "14985");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](177, "h6", 41);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](178, "Sum of Royalty");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](182, "mat-card-content");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](183, "mat-card-title");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](184, "Time line");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](185, "mat-card-subtitle");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](186, "Sum of Tonnes Vs Sum of Royalty");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](187, "div", 2);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](188, "apx-chart", 3);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](189, "ul", 4);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](190, "li");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](191, "h6", 5);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](192, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](193, "Sum of Royalty - 2019");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](195, "h6", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](196, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](197, "Sum of Tonnes - 2019");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](199, "h6", 5);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](200, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](201, "Sum of Royalty - 2020");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](203, "h6", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](204, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](205, "Sum of Tonnes - 2020 ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](207, "mat-card");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](208, "mat-card-content");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](209, "mat-card-title");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](210, "Monthly chart");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](211, "mat-card-subtitle");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](212, "Overview of Monthly chart");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](213, "div", 45);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](214, "apx-chart", 46);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](215, "ul", 47);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](216, "li");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](217, "h6", 5);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](218, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](219, "Mine 1");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](221, "h6", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](222, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](223, "Mine 2");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](225, "h6", 5);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](226, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](227, "Mine 3");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](229, "h6", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](230, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](231, "Mine 4");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](233, "h6", 5);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](234, "i", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](235, "Mine 5");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("pageSize", 5)("pageSizeOptions", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction0"](69, _c3));
      ...
      directives: [_angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_5__["DefaultLayoutDirective"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_5__["DefaultFlexDirective"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCard"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardContent"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardTitle"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardSubtitle"], ng_apexcharts__WEBPACK_IMPORTED_MODULE_4__["ChartComponent"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTable"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatColumnDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatHeaderCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatHeaderRowDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatRowDef"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_1__["MatPaginator"], ng2_charts__WEBPACK_IMPORTED_MODULE_7__["BaseChartDirective"], _angular_material_button__WEBPACK_IMPORTED_MODULE_8__["MatButton"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_9__["MatIcon"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatHeaderCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatHeaderRow"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatRow"]],
      styles: [".saleschart[_ngcontent-%COMP%] {\n  width: 100%; }\n\n.contactlist[_ngcontent-%COMP%]   .mat-row[_ngcontent-%COMP%] {\n  padding: 6px 15px; }\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
  ...
  /***/
  function srcAppDashboardsDashboard2DataJson(module) {
    module.exports = JSON.parse("{\"Bar\":{\"labels\":[\"Jan\",\"Feb\",\"Mar\",\"Apr\",\"May\",\"Jun\"],\"series\":[[9,4,11,7,10,12],[3,2,9,5,8,10]]},\"LineWithArea\":{\"labels\":[1,2,3,4,5,6,7,8],\"series\":[[0,5000,15000,8000,15000,9000,30000,0],[0,3000,5000,2000,8000,1000,5000,0]]},\"Pie\":{\"series\":[20,10,30,40]}}");
    /***/
  },
  ...
  /***/
  function srcAppDashboardsDashboardsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _dashboards_routing__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./dashboards.routing */
    ...
    var _dashboard1_dashboard1_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./dashboard1/dashboard1.component */
    "./src/app/dashboards/dashboard1/dashboard1.component.ts");
    /* harmony import */


    var _dashboard2_dashboard2_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    DashboardsModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: DashboardsModule
    });
    DashboardsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function DashboardsModule_Factory(t) {
        return new (t || DashboardsModule)();
      },
      providers: [],
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _demo_material_module__WEBPACK_IMPORTED_MODULE_4__["DemoMaterialModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_5__["FlexLayoutModule"], ng_chartist__WEBPACK_IMPORTED_MODULE_7__["ChartistModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_8__["ChartsModule"], ng_apexcharts__WEBPACK_IMPORTED_MODULE_9__["NgApexchartsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(_dashboards_routing__WEBPACK_IMPORTED_MODULE_6__["DashboardsRoutes"])]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DashboardsModule, {
        declarations: [_dashboard1_dashboard1_component__WEBPACK_IMPORTED_MODULE_10__["Dashboard1Component"], _dashboard2_dashboard2_component__WEBPACK_IMPORTED_MODULE_11__["Dashboard2Component"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _demo_material_module__WEBPACK_IMPORTED_MODULE_4__["DemoMaterialModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_5__["FlexLayoutModule"], ng_chartist__WEBPACK_IMPORTED_MODULE_7__["ChartistModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_8__["ChartsModule"], ng_apexcharts__WEBPACK_IMPORTED_MODULE_9__["NgApexchartsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DashboardsModule, [{
  ...
  /***/
  function srcAppDashboardsDashboardsRoutingTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
